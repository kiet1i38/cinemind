...
try {
  ...
  const requiredChecks = {
    ...
    ratingStarCount: report.ratingStarCount === 20,
    halfStarAvailable: report.halfStarAvailable === true,
    halfStarSelection: report.halfStarSelection === true,
    ratingUiValidation: report.ratingUiValidation === true,
    lowerBoundaryHalfStar: report.lowerBoundarySignal?.rating === 0.5,
    upperBoundaryTenStar: report.savedBoundarySignal?.rating === 10,
    ratingPrefillsAsStars: report.signalPrefill?.rating === "10 / 10",
    ...
    favoriteUiRemoved: report.favoriteUiRemoved === true,
